...
BEGIN
  ...
  -- Final balances after seeded financial actions and historical/open bets
  UPDATE balances
  SET available = CASE user_id
      WHEN user1_id THEN 1182
      WHEN user2_id THEN 845
      WHEN user3_id THEN 1166
      ELSE available
    END,
    in_play = CASE user_id
      ...
      ELSE in_play
    END,
    updated_at = '2026-03-20T16:02:00Z'
