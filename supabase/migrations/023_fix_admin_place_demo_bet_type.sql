-- Migration 023: Fix admin_place_demo_bet — use 'bet_lock' instead of 'bet_stake'
-- balance_transactions.type CHECK constraint only allows:
-- 'mint', 'transfer', 'bet_lock', 'bet_payout', 'adjustment'
...
BEGIN
  ...
  VALUES
    (p_user_id, auth.uid(), 'bet_lock', -p_stake, v_balance_after, v_bet_id,
