-- Migration 036: Replace total_collected_from_losers with total_stakes_collected
-- in the system_kpis view so the dashboard math is consistent:
...
SELECT
  ...
  COALESCE((
    ...
    FROM bets bt
    WHERE bt.settled_at IS NOT NULL
